...
gif_path = "/Users/vatsal/Desktop/CrystalOS/Crystal3.0/img/UI/Crystal new.gif"
...
def run():
    ...
    while True:
        ...
        if first_time == True:
            wish_me(recognize_user())
            first_time = False

        if (wake_word(command)is True or (eyes != "closed" and eyes != None and eyes != "None")) and command != "":
            ...
            summon = ['come here', 'come over here', 'come to me']
            ...
            if command.lower() in prompt_list:
                ...
                print(response)
            if response == "" or response == None and len(command) != 1:
                try:
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie(gif_path)
